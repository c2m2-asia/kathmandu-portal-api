...
router.register('download/bulk', views.DownloadBulkData, basename='download-datasets')
router.register('download/chart', views.DownloadIndvChartData, basename='download-datasets')
